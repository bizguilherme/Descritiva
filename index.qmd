...
\hline
\textbf{Altura das} & \mathbf{n_i} & \mathbf{N_i} & \mathbf{f_i} & \mathbf{F_i} & \textbf{%} & \textbf{Porc.} & \bar{x}_i \\
...
::: {style="font-align: justify; font-size: 0.8em;"}
<br> - É a diferença entre o maior e o menor valor observado $$A_t=x_{max}-x_{min}$$
...
-   Ilustre o Box-plot, em N, de uvas Niágaras, fornecidas por produtores na safrinha de 2002.
